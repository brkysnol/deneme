...
<div class="cntr b-w" style="max-width:990px; margin:0 auto;">
    <div class="hmp">
        ...
        <div class="model-videos" id="videos">
            <?php
            ...
            $sql = "SELECT {$pref}posts.ID FROM {$pref}posts INNER JOIN 
                        ...
                        {$pref}postmeta.meta_key = 'secili_model' AND
                        {$pref}postmeta.meta_value LIKE '%" . $postid . "%'
                        ORDER BY {$pref}posts.post_date DESC
                        ";
                    ...
                    <div class="video-item">
                        ...
                        <div class="video-details" style="font-size:13px;">
                            ...
                            <div style="font-size:12px;">
                                ...
                                $meta_models = json_decode(get_post_meta($post, 'secili_kanal', true));
                                if ($meta_models):
                                    if (is_array($meta_models)) {
                                        ...
                                        echo $tv ?>
                                        <a href="<?php echo get_the_permalink($meta_models) ?>amp/"><?php echo get_the_title($meta_models) ?></a>
                                        <?php
                                    }
                                endif;
